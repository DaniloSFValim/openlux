-- Fix: Adicionar coluna 'fonte' obrigatória em ip_inserir_ponto
-- Problema: RPC não estava inserindo valor na coluna 'fonte' (NOT NULL)
-- Erro: 'null value in column "fonte" violates not-null constraint'

-- Atualizar ip_inserir_ponto para incluir coluna 'fonte' com valor padrão
